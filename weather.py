...
# Image 
new = ImageTk.PhotoImage(Image.open('indirr.png')) 
...
month = Label(root, text=dt.strftime('%Y-%m-%d'), bg='white', font=("bold", 15)) 
...
def city_name(): 
    ...
    api_request = requests.get("https://api.openweathermap.org/data/2.5/weather?q="
                               + city_entry.get() + "&units=metric&appid="+'write_your_key_to_here') 
